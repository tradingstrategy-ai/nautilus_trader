...
/// The complete set of HL WS channels that key by wallet address.
///
/// Subscribing to any of these from N IPs would deliver each event N
/// times. The pool hard-pins these to slot 0 to enforce exactly-once
/// semantics for wallet events.
...
///
/// Used by callers that work in raw HL strings. The HL WS adapter itself
/// uses typed methods that don't need this.
///
/// Examples:
///
/// | Input              | Output                       |
