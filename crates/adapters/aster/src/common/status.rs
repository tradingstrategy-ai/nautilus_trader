...
//! Instrument status mapping and polling for the Aster adapter.
...
mod tests {
    ...
    use super::{
        super::enums::{AsterContractStatus, AsterTradingStatus},
        *,
    };

    #[rstest]
    #[case(AsterTradingStatus::Trading, MarketStatusAction::Trading)]
    #[case(AsterTradingStatus::PendingTrading, MarketStatusAction::PreOpen)]
    #[case(AsterTradingStatus::PreTrading, MarketStatusAction::PreOpen)]
    #[case(AsterTradingStatus::PostTrading, MarketStatusAction::PostClose)]
    #[case(AsterTradingStatus::EndOfDay, MarketStatusAction::Close)]
    #[case(AsterTradingStatus::Halt, MarketStatusAction::Halt)]
    #[case(AsterTradingStatus::AuctionMatch, MarketStatusAction::Cross)]
    #[case(AsterTradingStatus::Break, MarketStatusAction::Pause)]
    #[case(
        AsterTradingStatus::Unknown,
        MarketStatusAction::NotAvailableForTrading
    )]
    fn test_trading_status_to_market_action(
        #[case] input: AsterTradingStatus,
    ...
    #[rstest]
    #[case(AsterContractStatus::Trading, MarketStatusAction::Trading)]
    #[case(AsterContractStatus::PendingTrading, MarketStatusAction::PreOpen)]
    #[case(AsterContractStatus::PreDelivering, MarketStatusAction::PreClose)]
    #[case(AsterContractStatus::Delivering, MarketStatusAction::Close)]
    #[case(AsterContractStatus::Delivered, MarketStatusAction::Close)]
    #[case(AsterContractStatus::PreDelisting, MarketStatusAction::PreClose)]
    #[case(AsterContractStatus::Delisting, MarketStatusAction::Suspend)]
    #[case(
        AsterContractStatus::Down,
        MarketStatusAction::NotAvailableForTrading
    )]
    #[case(
        AsterContractStatus::Unknown,
        MarketStatusAction::NotAvailableForTrading
    )]
    fn test_contract_status_to_market_action(
        #[case] input: AsterContractStatus,
        #[case] expected: MarketStatusAction,
    ) {
        assert_eq!(MarketStatusAction::from(input), expected);
    }
    ...
    fn test_diff_emits_on_change() {
        ...
        let id = InstrumentId::from("BTCUSDT.ASTER");
    ...
    fn test_diff_emits_for_new_symbol() {
        let (tx, mut rx) = tokio::sync::mpsc::unbounded_channel();
        let id = InstrumentId::from("ETHUSDT.ASTER");
