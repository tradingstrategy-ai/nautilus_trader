...
//! Shared data transfer objects used across Aster HTTP and WebSocket payloads.

use serde::{Deserialize, Serialize};

use crate::common::enums::{AsterFilterType, AsterRateLimitInterval, AsterRateLimitType};

/// Aster API error response structure.
///
/// Aster returns this format for error responses:
/// ```json
/// {"code": -1000, "msg": "An unknown error occurred"}
/// ```
#[derive(Clone, Debug, Deserialize)]
pub struct AsterErrorResponse {
    /// Aster error code (negative number indicates error).
    pub code: i64,
...
///
/// # References
/// - <https://developers.asterdex.com/docs/aster-spot-api-docs/filters#price_filter>
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SpotPriceFilter {
    /// Filter type identifier.
    pub filter_type: AsterFilterType,
...
///
/// # References
/// - <https://developers.asterdex.com/docs/aster-spot-api-docs/filters#lot_size>
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
///
/// # References
/// - <https://developers.asterdex.com/docs/aster-spot-api-docs/filters#market_lot_size>
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
///
/// # References
/// - <https://developers.asterdex.com/docs/aster-spot-api-docs/filters#notional>
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
///
/// # References
/// - <https://developers.asterdex.com/docs/aster-spot-api-docs/filters#percent_price>
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
///
/// # References
/// - <https://developers.asterdex.com/docs/derivatives/usds-margined-futures/market-data/rest-api/Exchange-Information>
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
mod tests {
    ...
    #[rstest]
    fn test_aster_rate_limit_deserializes_known_values() {
        let json = r#"{
        ...
        let rate_limit: AsterRateLimit = serde_json::from_str(json).unwrap();

        assert_eq!(
            rate_limit.rate_limit_type,
            AsterRateLimitType::RequestWeight
        );
        assert_eq!(rate_limit.interval, AsterRateLimitInterval::Minute);
        assert_eq!(rate_limit.interval_num, 1);
        assert_eq!(rate_limit.limit, 2400);
    }

    #[rstest]
    fn test_aster_rate_limit_deserializes_unknown_values() {
        let json = r#"{
        ...
        assert_eq!(rate_limit.rate_limit_type, AsterRateLimitType::Unknown);
        assert_eq!(rate_limit.interval, AsterRateLimitInterval::Unknown);
