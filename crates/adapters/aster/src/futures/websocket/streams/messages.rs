...
//! Aster Futures WebSocket message types.
//!
//! Futures streams use standard JSON encoding (not SBE like Spot).
//!
//! The handler emits venue-specific types via [`AsterFuturesWsStreamsMessage`].
...
use crate::{
    common::enums::{
        AsterAlgoStatus, AsterAlgoType, AsterFuturesOrderType, AsterKlineInterval,
        AsterMarginType, AsterOrderStatus, AsterPositionSide, AsterPriceMatch,
        AsterSelfTradePreventionMode, AsterSide, AsterTimeInForce, AsterWorkingType,
        AsterWsMethod,
    },
    futures::http::AsterFuturesInstrument,
};
...
pub enum AsterFuturesWsStreamsMessage {
    /// Aggregate trade stream.
    AggTrade(AsterFuturesAggTradeMsg),
    /// Trade stream.
    Trade(AsterFuturesTradeMsg),
    /// Best bid/ask (book ticker) stream.
    BookTicker(AsterFuturesBookTickerMsg),
    /// Order book depth update stream.
    DepthUpdate(AsterFuturesDepthUpdateMsg),
    /// Mark price stream.
    MarkPrice(AsterFuturesMarkPriceMsg),
    /// Kline/candlestick stream.
    Kline(AsterFuturesKlineMsg),
    /// Force liquidation order stream.
    ForceOrder(AsterFuturesLiquidationMsg),
    /// 24hr ticker stream.
    Ticker(AsterFuturesTickerMsg),
    /// Account update (balance/position changes).
    AccountUpdate(AsterFuturesAccountUpdateMsg),
    /// Order/trade update.
    OrderUpdate(Box<AsterFuturesOrderUpdateMsg>),
    /// Algo order update (conditional orders via Algo Service).
    AlgoUpdate(Box<AsterFuturesAlgoUpdateMsg>),
    /// Margin call warning.
    MarginCall(AsterFuturesMarginCallMsg),
    /// Account configuration change (leverage, etc.).
    AccountConfigUpdate(AsterFuturesAccountConfigMsg),
    /// Listen key expired.
    ListenKeyExpired,
    /// Error from the server.
    Error(AsterFuturesWsErrorMsg),
    /// WebSocket reconnected.
    Reconnected,
}

/// Error message from Aster Futures WebSocket.
#[derive(Debug, Clone)]
pub struct AsterFuturesWsErrorMsg {
...
pub enum AsterFuturesWsStreamsCommand {
...
pub enum ExecHandlerCommand {
    ...
    InitializeInstruments(Vec<AsterFuturesInstrument>),
    /// Update a single instrument in the handler cache.
    UpdateInstrument(AsterFuturesInstrument),
...
pub struct AsterFuturesAggTradeMsg {
    /// Event type.
    #[serde(rename = "e")]
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesTradeMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesDepthUpdateMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesMarkPriceMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesBookTickerMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Update ID.
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesKlineMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
    ...
    /// Kline data.
    #[serde(rename = "k")]
    pub kline: AsterFuturesKlineData,
}

/// Kline data within kline message.
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesKlineData {
    /// Kline start time.
    #[serde(rename = "t")]
    pub start_time: i64,
    /// Kline close time.
    ...
    /// Kline interval.
    #[serde(rename = "i")]
    pub interval: AsterKlineInterval,
    /// First trade ID.
    #[serde(rename = "f")]
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesLiquidationMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
    ...
    /// Order data.
    #[serde(rename = "o")]
    pub order: AsterFuturesLiquidationOrder,
}

/// Liquidation order details.
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesLiquidationOrder {
    /// Symbol.
    #[serde(rename = "s")]
    pub symbol: Ustr,
    /// Order side.
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesTickerMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
...
pub struct AsterFuturesWsSubscribeRequest {
    /// Request method.
    pub method: AsterWsMethod,
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesWsSubscribeResponse {
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesWsErrorResponse {
    /// Error code.
    pub code: i64,
    /// Error message.
    pub msg: String,
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesAccountUpdateMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesOrderUpdateMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
...
pub struct OrderUpdateData {
    ...
    /// Execution type.
    #[serde(rename = "x")]
    pub execution_type: AsterExecutionType,
    /// Order status.
    #[serde(rename = "X")]
    pub order_status: AsterOrderStatus,
    /// Order ID.
    #[serde(rename = "i")]
    pub order_id: i64,
    ...
    /// Working type.
    #[serde(rename = "wt")]
    pub working_type: AsterWorkingType,
    /// Original order type.
    #[serde(rename = "ot")]
    pub original_order_type: AsterFuturesOrderType,
    /// Position side.
    #[serde(rename = "ps")]
    pub position_side: AsterPositionSide,
    ...
    pub stp_mode: Option<AsterSelfTradePreventionMode>,
    /// Price match mode.
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesMarginCallMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesAccountConfigMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
...
/// Algo order update event from user data stream (Aster Futures Algo Service).
///
...
/// # References
///
/// - <https://developers.asterdex.com/docs/derivatives/usds-margined-futures/user-data-streams/Event-Algo-Order-Update>
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesAlgoUpdateMsg {
...
pub struct AlgoOrderUpdateData {
    ...
    #[serde(rename = "X")]
    pub algo_status: AsterAlgoStatus,
    /// Trigger price.
    #[serde(rename = "tp")]
...
#[derive(Debug, Clone, Deserialize)]
pub struct AsterFuturesListenKeyExpiredMsg {
    /// Event type.
    #[serde(rename = "e")]
    pub event_type: String,
    /// Event time in milliseconds.
