...
//! Aster Futures WebSocket clients.
//!
//! This module provides WebSocket clients for Aster Futures:
//!
...
//! ## Trading API (`trading`)
//!
//! Request/response pattern for order management via `ws-fapi.asterdex.com`:
...
pub use streams::AsterFuturesWebSocketClient;
pub use trading::AsterFuturesWsTradingClient;
