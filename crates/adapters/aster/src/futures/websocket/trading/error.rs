...
//! Aster Futures WebSocket Trading API error types.

use std::fmt::Display;

/// Aster Futures WebSocket Trading API error type.
#[derive(Debug)]
pub enum AsterFuturesWsApiError {
...
impl Display for AsterFuturesWsApiError {
...
impl std::error::Error for AsterFuturesWsApiError {}

/// Result type for Aster Futures WebSocket Trading API operations.
pub type AsterFuturesWsApiResult<T> = Result<T, AsterFuturesWsApiError>;
