...
//! Aster Futures HTTP query parameter builders.

use derive_builder::Builder;
use serde::{Deserialize, Serialize};

use crate::common::enums::{
    AsterAlgoType, AsterFuturesOrderType, AsterIncomeType, AsterMarginType,
    AsterPositionSide, AsterPriceMatch, AsterSelfTradePreventionMode, AsterSide,
    AsterTimeInForce, AsterWorkingType,
};
...
pub struct AsterTicker24hrParams {
...
#[builder(default)]
#[builder(setter(into, strip_option))]
pub struct AsterBookTickerParams {
    /// Filter by single symbol.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub symbol: Option<String>,
}
...
#[builder(default)]
#[builder(setter(into, strip_option))]
pub struct AsterMarkPriceParams {
    /// Filter by single symbol.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub symbol: Option<String>,
}
...
#[builder(default)]
#[builder(setter(into, strip_option))]
pub struct AsterFundingRateParams {
    /// Trading symbol.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub symbol: Option<String>,
    /// Start time in milliseconds.
...
#[builder(setter(into))]
pub struct AsterOpenInterestParams {
    /// Trading symbol (required).
    pub symbol: String,
}
...
#[builder(default)]
#[builder(setter(into, strip_option))]
pub struct AsterFuturesBalanceParams {
...
#[builder(default)]
#[builder(setter(into, strip_option))]
pub struct AsterPositionRiskParams {
    /// Filter by symbol.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub symbol: Option<String>,
    /// Recv window override (ms).
...
#[derive(Clone, Debug, Default, Deserialize, Serialize, Builder)]
#[builder(setter(into, strip_option), default)]
pub struct AsterUserTradesParams {
    /// Trading symbol (required).
    pub symbol: String,
...
#[builder(default)]
#[builder(setter(into, strip_option))]
pub struct AsterOpenOrdersParams {
    /// Filter by symbol.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub symbol: Option<String>,
    /// Recv window override (ms).
...
#[derive(Clone, Debug, Default, Deserialize, Serialize, Builder)]
#[builder(setter(into, strip_option), default)]
pub struct AsterOrderQueryParams {
    /// Trading symbol (required).
    pub symbol: String,
    /// Order ID.
    #[serde(rename = "orderId", skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, Deserialize, Serialize, Builder)]
#[builder(setter(into, strip_option))]
pub struct AsterNewOrderParams {
    /// Trading symbol (required).
    pub symbol: String,
    /// Order side (required).
    pub side: AsterSide,
...
#[derive(Clone, Debug, Default, Deserialize, Serialize, Builder)]
#[builder(setter(into, strip_option), default)]
pub struct AsterCancelOrderParams {
    /// Trading symbol (required).
    pub symbol: String,
    /// Order ID.
    #[serde(rename = "orderId", skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, Default, Deserialize, Serialize, Builder)]
#[builder(setter(into, strip_option), default)]
pub struct AsterCancelAllOrdersParams {
    /// Trading symbol (required).
    pub symbol: String,
    /// Recv window override (ms).
    #[serde(rename = "recvWindow", skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, Deserialize, Serialize, Builder)]
#[builder(setter(into, strip_option))]
pub struct AsterModifyOrderParams {
    /// Trading symbol (required).
    pub symbol: String,
    /// Order ID.
    #[serde(rename = "orderId", skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, Default, Deserialize, Serialize, Builder)]
#[builder(setter(into, strip_option), default)]
pub struct AsterAllOrdersParams {
    /// Trading symbol (required).
    pub symbol: String,
...
#[derive(Clone, Debug, Deserialize, Serialize, Builder)]
#[builder(setter(into))]
pub struct AsterSetLeverageParams {
    /// Trading symbol (required).
    pub symbol: String,
...
#[derive(Clone, Debug, Deserialize, Serialize, Builder)]
#[builder(setter(into))]
pub struct AsterSetMarginTypeParams {
    /// Trading symbol (required).
    pub symbol: String,
...
#[builder(setter(into, strip_option))]
#[serde(rename_all = "camelCase")]
pub struct AsterNewAlgoOrderParams {
    /// Trading symbol (required).
    pub symbol: String,
    /// Order side (required).
    pub side: AsterSide,
...
#[builder(setter(into, strip_option), default)]
#[serde(rename_all = "camelCase")]
pub struct AsterAlgoOrderQueryParams {
    /// Algo order ID.
...
#[builder(setter(into, strip_option), default)]
#[serde(rename_all = "camelCase")]
pub struct AsterOpenAlgoOrdersParams {
...
#[builder(setter(into, strip_option))]
#[serde(rename_all = "camelCase")]
pub struct AsterAllAlgoOrdersParams {
    /// Trading symbol (required).
    pub symbol: String,
    /// Start time in milliseconds.
    #[serde(rename = "startTime", skip_serializing_if = "Option::is_none")]
...
#[builder(setter(into, strip_option))]
#[serde(rename_all = "camelCase")]
pub struct AsterCancelAllAlgoOrdersParams {
    /// Trading symbol (required).
    pub symbol: String,
    /// Recv window override (ms).
    #[serde(rename = "recvWindow", skip_serializing_if = "Option::is_none")]
...
mod tests {
    ...
    fn test_depth_params_builder() {
        let params = AsterDepthParamsBuilder::default()
            .symbol("BTCUSDT")
            .limit(100u32)
            .build()
            .unwrap();
    ...
    fn test_ticker_params_serialization() {
        let params = AsterTicker24hrParams {
    ...
    fn test_order_query_params_builder() {
        let params = AsterOrderQueryParamsBuilder::default()
            .symbol("BTCUSDT")
            .order_id(12345_i64)
    ...
    fn test_income_history_params_serialization() {
        let params = AsterIncomeHistoryParamsBuilder::default()
            .symbol("ETHUSDT")
            .income_type(AsterIncomeType::FundingFee)
            .limit(50_u32)
            .build()
            .unwrap();
    ...
    fn test_open_orders_params_builder() {
        let params = AsterOpenOrdersParamsBuilder::default()
            .symbol("BNBUSDT")
            .build()
            .unwrap();
    ...
    fn test_new_algo_order_params_serialization_uses_activate_price() {
        let params = AsterNewAlgoOrderParamsBuilder::default()
            .symbol("ETHUSDT")
            .side(AsterSide::Sell)
            .order_type(AsterFuturesOrderType::TrailingStopMarket)
    ...
    fn test_new_order_params_with_price_match_serializes_correctly() {
        let params = AsterNewOrderParams {
            ...
            side: AsterSide::Buy,
            order_type: AsterFuturesOrderType::Limit,
            time_in_force: Some(AsterTimeInForce::Gtc),
            ...
            good_till_date: None,
            recv_window: None,
            price_match: Some(AsterPriceMatch::Opponent5),
