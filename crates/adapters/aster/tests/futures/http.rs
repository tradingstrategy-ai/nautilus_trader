...
//! Integration tests for the Aster Futures HTTP client using a mock server.
...
use nautilus_aster::{
    common::enums::{
        AsterEnvironment, AsterFuturesOrderType, AsterProductType, AsterSide,
        AsterTimeInForce,
    },
    futures::http::{client::AsterRawFuturesHttpClient, query::AsterNewOrderParamsBuilder},
};
use rstest::rstest;
use serde_json::json;
