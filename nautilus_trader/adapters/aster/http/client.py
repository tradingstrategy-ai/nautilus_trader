...
from nautilus_trader.adapters.aster.http.error import AsterServerError
...
class AsterHttpClient:
    """
    Provides an Aster asynchronous HTTP client.
    ...
    api_key : str, optional
        The Aster API key for requests.
        If ``None``, the client will work for public market data only.
    api_secret : str, optional
        The Aster API secret for signed requests.
        If ``None``, the client will work for public market data only.
    ...
    def api_key(self) -> str | None:
        """
        Return the Aster API key being used by the client.
    ...
    def api_key_masked(self) -> str:
        """
        Return the masked Aster API key being used by the client.
