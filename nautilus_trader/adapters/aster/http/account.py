...
from nautilus_trader.adapters.aster.common.enums import AsterNewOrderRespType
...
class AsterOrderHttp(AsterHttpEndpoint):
    """
    ...
    References
    ----------
    https://docs.asterdex.com/spot/en/#new-order-trade
    https://docs.asterdex.com/futures/en/#new-order-trade
    https://docs.asterdex.com/delivery/en/#new-order-trade
    https://docs.asterdex.com/futures/en/#modify-order-trade
    https://docs.asterdex.com/delivery/en/#modify-order-trade
    ...
    def __init__(
        ...
        methods = {
            ...
            HttpMethod.PUT: AsterSecurityType.TRADE,
        }
        ...
        self._resp_decoder = msgspec.json.Decoder(AsterOrder)
    ...
    class PostParameters(msgspec.Struct, omit_defaults=True, frozen=True):
        ...
        priceMatch : str, optional
            ...
            Enables Aster BBO matching; cannot be sent together with `price`.
        ...
        newOrderRespType: AsterNewOrderRespType | None = None
    ...
    async def get(self, params: GetDeleteParameters) -> AsterOrder:
        method_type = HttpMethod.GET
        raw = await self._method(method_type, params)
        return self._resp_decoder.decode(raw)

    async def delete(self, params: GetDeleteParameters) -> AsterOrder:
        method_type = HttpMethod.DELETE
        raw = await self._method(method_type, params)
        return self._resp_decoder.decode(raw)

    async def post(self, params: PostParameters) -> AsterOrder:
        method_type = HttpMethod.POST
        raw = await self._method(method_type, params)
        return self._resp_decoder.decode(raw)

    async def put(self, params: PutParameters) -> AsterOrder:
        method_type = HttpMethod.PUT
        raw = await self._method(method_type, params)
        return self._resp_decoder.decode(raw)


class AsterAllOrdersHttp(AsterHttpEndpoint):
    """
    ...
    References
    ----------
    https://docs.asterdex.com/spot/en/#all-orders-user_data
    https://docs.asterdex.com/futures/en/#all-orders-user_data
    https://docs.asterdex.com/delivery/en/#all-orders-user_data
    ...
    def __init__(
        ...
        self._get_resp_decoder = msgspec.json.Decoder(list[AsterOrder])
    ...
    async def get(self, params: GetParameters) -> list[AsterOrder]:
        method_type = HttpMethod.GET
        raw = await self._method(method_type, params)
        return self._get_resp_decoder.decode(raw)


class AsterOpenOrdersHttp(AsterHttpEndpoint):
    """
    ...
    References
    ----------
    https://docs.asterdex.com/spot/en/#current-open-orders-user_data
    https://docs.asterdex.com/futures/en/#current-all-open-orders-user_data
    https://docs.asterdex.com/futures/en/#current-all-open-orders-user_data
    ...
    def __init__(
        ...
        client: AsterHttpClient,
        base_endpoint: str,
        methods: dict[HttpMethod, AsterSecurityType] | None = None,
    ):
        if methods is None:
            methods = {
                HttpMethod.GET: AsterSecurityType.USER_DATA,
...
class AsterUserTradesHttp(AsterHttpEndpoint):
    """
    ...
    References
    ----------
    https://docs.asterdex.com/spot/en/#account-trade-list-user_data
    https://docs.asterdex.com/futures/en/#account-trade-list-user_data
    https://docs.asterdex.com/delivery/en/#account-trade-list-user_data
    ...
    def __init__(
        ...
        self._get_resp_decoder = msgspec.json.Decoder(list[AsterUserTrade])
    ...
    async def _get(self, params: GetParameters) -> list[AsterUserTrade]:
        method_type = HttpMethod.GET
        raw = await self._method(method_type, params)
        return self._get_resp_decoder.decode(raw)


class AsterAccountHttpAPI:
    """
    Provides access to the Aster Account/Trade HTTP REST API.
    ...
    def __init__(
        ...
        # Create endpoints
        self._endpoint_order = AsterOrderHttp(client, self.base_endpoint)
        self._endpoint_all_orders = AsterAllOrdersHttp(client, self.base_endpoint)
        self._endpoint_open_orders = AsterOpenOrdersHttp(client, self.base_endpoint)
        self._endpoint_user_trades = AsterUserTradesHttp(client, user_trades_url)
    ...
    async def query_order(
        ...
        aster_order = await self._endpoint_order.get(
    ...
    async def cancel_order(
        ...
        aster_order = await self._endpoint_order.delete(
            params=self._endpoint_order.GetDeleteParameters(
                symbol=AsterSymbol(symbol),
                timestamp=self._timestamp(),
                orderId=order_id,
    ...
    async def new_order(
        ...
        new_order_resp_type: AsterNewOrderRespType | None = None,
        recv_window: str | None = None,
    ) -> AsterOrder:
        """
        Send in a new order to Aster.
        """
        aster_order = await self._endpoint_order.post(
    ...
    async def modify_order(
        ...
        """
        Modify a LIMIT order with Aster.
        """
        aster_order = await self._endpoint_order.put(
