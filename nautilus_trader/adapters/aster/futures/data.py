...
from nautilus_trader.adapters.aster.data import AsterCommonDataClient
...
from nautilus_trader.adapters.aster.futures.schemas.market import AsterFuturesMarkPriceAllMsg
from nautilus_trader.adapters.aster.futures.schemas.market import AsterFuturesMarkPriceData
from nautilus_trader.adapters.aster.futures.schemas.market import AsterFuturesMarkPriceMsg
from nautilus_trader.adapters.aster.futures.schemas.market import AsterFuturesTradeMsg
...
class AsterFuturesDataClient(AsterCommonDataClient):
    """
    Provides a data client for the Aster Futures exchange.
    ...
    def __init__(
        ...
        self._decoder_futures_trade_msg = msgspec.json.Decoder(AsterFuturesTradeMsg)
        self._decoder_futures_mark_price_msg = msgspec.json.Decoder(AsterFuturesMarkPriceMsg)
        self._decoder_futures_mark_price_all_msg = msgspec.json.Decoder(
            AsterFuturesMarkPriceAllMsg,
        )
    ...
    def _handle_mark_price_data(self, data: AsterFuturesMarkPriceData) -> None:
        instrument_id: InstrumentId = self._get_cached_instrument_id(data.s)
        data = data.parse_to_aster_futures_mark_price_update(
            instrument_id=instrument_id,
            ts_init=self._clock.timestamp_ns(),
        )
        data_type = DataType(
