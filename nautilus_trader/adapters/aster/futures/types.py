...
class AsterFuturesMarkPriceUpdate(Data):
    """
    Represents a Aster Futures mark price and funding rate update.
    ...
    References
    ----------
    https://developers.aster.com/docs/derivatives/usds-margined-futures/websocket-market-streams/Mark-Price-Stream
    ...
    @staticmethod
    def from_dict(values: dict[str, Any]) -> AsterFuturesMarkPriceUpdate:
        """
        Return a Aster Futures mark price update parsed from the given values.
    ...
    @staticmethod
    def to_dict(obj: AsterFuturesMarkPriceUpdate) -> dict[str, Any]:
        """
