...
class AsterBar(Bar):
    """
    Represents an aggregated Aster bar.

    This data type includes the raw data provided by Aster.
    ...
    @staticmethod
    def from_dict(values: dict[str, Any]) -> AsterBar:
        """
        Return an Aster bar parsed from the given values.
    ...
    @staticmethod
    def to_dict(obj: AsterBar) -> dict[str, Any]:
        """
...
class AsterTicker(Data):
    """
    Represents an Aster 24hr statistics ticker.
    ...
    def __eq__(self, other: object) -> bool:
        if other is None:
            return False
        if not isinstance(other, AsterTicker):
            return False
    ...
    @staticmethod
    def from_dict(values: dict[str, Any]) -> AsterTicker:
        """
        Return an Aster Spot/Margin ticker parsed from the given values.
    ...
    @staticmethod
    def to_dict(obj: AsterTicker) -> dict[str, Any]:
        """
        Return a dictionary representation of this object.
